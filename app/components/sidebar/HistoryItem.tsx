...
export function HistoryItem({ item, onDelete, onNavigate }: HistoryItemProps) {
  ...
  return (
    ...
    >
      <a href={`/chat/${item.urlId}`} className="flex w-full relative truncate block" onClick={onNavigate}>
        {item.description}
